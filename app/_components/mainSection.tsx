      ...
      <div className="px-8 py-9 flex flex-col gap-4">
        ...
        <div className="flex justify-between items-start gap-8">
          ...
          <ul className="flex flex-col gap-3 list-disc list-outside m-0 p-0 pt-2">
            <li className="text-[16px]/[16px]  text-[#f44] font-bold max-w-[191px]">
              Como melhorar a experiência de compra com IA.
            </li>
            <li className="text-[16px]/[16px] text-[#f44] font-bold max-w-[180px]">
        ...
        <a
          href="/Ebook_Potencial_AI_Supermercados.pdf" // Caminho relativo ao arquivo PDF
          download="Ebook_Potencial_AI_Supermercados.pdf" // Nome do arquivo a ser baixado
